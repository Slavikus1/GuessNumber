...
import com.example.guessnumber.data.GuessNumberRepositoryImpl
import com.example.guessnumber.domain.domain.entity.GameResult
...
import com.example.guessnumber.domain.domain.usecases.GenerateQuestionsUseCase
import com.example.guessnumber.domain.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(
    ...
    private val repository = GuessNumberRepositoryImpl
